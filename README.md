...
I'm a Master's student in Informatics at the University of Bremen, focused on full-stack development and data-driven applications. I build clean, scalable systems — from robust back-ends to intuitive user interfaces.

With multilingual fluency and international academic experience, I bring both technical depth and communication versatility to every team.

---

## 🔭 Currently Working On

Deepening expertise in **cloud-native architectures** and **containerised deployments** with Docker and Spring Boot, while exploring data visualisation pipelines using Power BI and SQL.
...
**Languages**
`Python` `Java` `HTML5` `CSS3` `SQL`

**Frameworks & Tools**
`Spring Boot` `Angular` `React` `Next.js` `Docker` `Git` `Power BI`
